    ...
    return __generator(this, function (_c) {
        switch (_c.label) {
            ...
            case 2:
                ...
                user = users[0];
                if (!user)
                    return [2 /*return*/, res.status(404).json({ error: "No such user exits" })];
                return [4 /*yield*/, payload.find({
                        collection: "orders",
                        where: {
                            id: {
            ...
            case 3:
                ...
                order = orders[0];
                if (!order)
                    return [2 /*return*/, res.status(404).json({ error: "NO such order exits" })];
            ...
            case 5:
                ...
                return [4 /*yield*/, resend.emails.send({
                        from: "DigitalHippo <vikaswakde@vikasbuilds.co>",
                        to: [user.email],
